                ...
                <div className="mh-top-links svelte-13h39ov">
                    <dl className="svelte-12h6dnj">
                        ...
                        <dd className="svelte-12h6dnj">
                            <a href="https://www.spotify.com/il-en/about-us/contact/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="about">About</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://www.lifeatspotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="jobs">Jobs</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://newsroom.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="press">For the Record</a> </dd></dl>
                    <dl className="svelte-12h6dnj"><dt className="svelte-12h6dnj">Communities</dt><dd className="svelte-12h6dnj"><a href="https://artists.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="artists">For Artists</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://developer.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="developers">Developers</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://ads.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="advertising">Advertising</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://investors.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="investors">Investors</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://spotifyforvendors.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="vendors">Vendors</a> </dd></dl>
                    <dl className="svelte-12h6dnj"><dt className="svelte-12h6dnj">Useful links</dt><dd className="svelte-12h6dnj"><a href="https://support.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="help">Support</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://open.spotify.com/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="play">Web Player</a> </dd>
                        <dd className="svelte-12h6dnj"><a href="https://www.spotify.com/il-en/download/" className="mh-footer-primary svelte-12h6dnj" data-ga-category="menu" data-ga-action="free">Free Mobile App</a> </dd></dl>
                </div>
                {/* <div className="mh-social-icons svelte-13h39ov">
                    <ul className="svelte-1ad7r0v">
                        <li className="svelte-1ad7r0v">
                            <a href="https://instagram.com/spotify" title="Instagram" className="mh-footer-primary svelte-1ad7r0v">
                                <span role="img" aria-label="Instagram" className="mh-social-icon-instagram svelte-1ad7r0v"></span></a> </li>
                        <li className="svelte-1ad7r0v"><a href="https://twitter.com/spotify" title="Twitter" className="mh-footer-primary svelte-1ad7r0v"><span role="img" aria-label="Twitter" className="mh-social-icon-twitter svelte-1ad7r0v"></span></a> </li>
                        <li className="svelte-1ad7r0v"><a href="https://www.facebook.com/Spotify" title="Facebook" className="mh-footer-primary svelte-1ad7r0v"><span role="img" aria-label="Facebook" className="mh-social-icon-facebook svelte-1ad7r0v"></span></a> </li></ul>
                </div> */}
                <div className="mh-country svelte-13h39ov">
                    {/* <a href="https://www.spotify.com/il-en/select-your-country-region/" className="mh-footer-secondary mh-compact svelte-1ouzkfx">
                    <svg width="12" height="13" viewBox="0 0 12 13" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" className="svelte-184rsfv">
                    ...
                    Israel (English)</a> */}
                    <span className="svelte-1so9ic8">© 2022 Audiofy</span>
                    </div>
                {/* <div className="mh-bottom-links svelte-13h39ov">
                    <ul className="svelte-19l7cif">
                        <li className="svelte-19l7cif">
                            <a href="https://www.spotify.com/il-en/legal/" className="mh-footer-secondary svelte-1ouzkfx">Legal</a> </li>
                        <li className="svelte-19l7cif"><a href="https://www.spotify.com/il-en/privacy/" className="mh-footer-secondary svelte-1ouzkfx">Privacy Center</a> </li>
                        <li className="svelte-19l7cif"><a href="https://www.spotify.com/il-en/legal/privacy-policy/" className="mh-footer-secondary svelte-1ouzkfx">Privacy Policy</a> </li>
                        <li className="svelte-19l7cif"><a href="https://www.spotify.com/il-en/legal/cookies-policy/" className="mh-footer-secondary svelte-1ouzkfx">Cookies</a> </li>
                        <li className="svelte-19l7cif"><a href="https://www.spotify.com/il-en/legal/privacy-policy/#s3" className="mh-footer-secondary svelte-1ouzkfx">About Ads</a> </li>
                    </ul>
                </div> */}
            </nav>
        </footer>
